...
class ImageConditionedMixin:
    ...
    def encode_image(self, image: Union[torch.Tensor, List[Image.Image]]) -> torch.Tensor:
        ...
        features = self.image_cond_model['model'](image, is_training=True)['x_prenorm'] #4x1374x1024
        patchtokens = F.layer_norm(features, features.shape[-1:]) #4x1374x1024
        return patchtokens #4x1374x1024
    ...
    def get_cond(self, cond, **kwargs):
        ...
        cond = super().get_cond(cond, **kwargs)#classifier_free_guidance.py
        return cond
