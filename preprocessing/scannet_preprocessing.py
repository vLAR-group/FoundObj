...
class ScannetPreprocessing(BasePreprocessing):
    def __init__(
        ...
        save_dir: str = "../data/scannet/processed_aligns",
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Preprocess ScanNet 20-class data")
    parser.add_argument("--data-dir", "--data_dir", default="../data/scannet/raw")
    parser.add_argument("--save-dir", "--save_dir", default="../data/scannet/processed_aligns")
    parser.add_argument("--modes", nargs="+", default=["train", "validation", "test"])
    parser.add_argument("--n-jobs", "--n_jobs", type=int, default=-1)
