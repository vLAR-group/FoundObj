...
# ---------- Label info ---------- #
CLASS_LABELS = ['02691156', '04401088', '02933112', '04090263', '03001627', '04256520']
VALID_CLASS_IDS = np.array([1, 2, 3, 4, 5, 6])
ID_TO_LABEL = {}
LABEL_TO_ID = {}
...
def assign_instances_for_scan(use_label: bool, pred: dict, gt_ids):
    ###########################################
